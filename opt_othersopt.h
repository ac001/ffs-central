...
#ifndef OPT_OTHERSOPT_H
#define OPT_OTHERSOPT_H

#include "ui_option_othersopt_base.h"
 ...
 */
class KFFOpt_othersopt : public KFFOpt_skeleton
{
Q_OBJECT
public:
    KFFOpt_othersopt(QWidget *parent = 0);

    ~KFFOpt_othersopt();


private:
	Ui::opt_othersopt ui_widget;
